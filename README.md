...
![Dashboard Screenshot](Images/dashboard_screenshot.png.png)
...
├── Excel/
│   └── Amazon_Marketplace_Dashboard.xlsx   (includes raw dataset + all analysis)
├── Images/
│   └── dashboard_screenshot.png
└── README.md
```

**Note:** the raw dataset is embedded as a sheet within the Excel workbook itself (see the `Amezon_product` tab), rather than provided as a separate CSV.
